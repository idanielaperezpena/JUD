...
namespace Negocio
{
    public class CiudadanoService : ServiceBase
    {
        ...
        public CiudadanoInsertarViewModel Insertar(string IDEncriptado)
        {
        ...
        private DomicilioFormViewModel GetDomicilio()
        {
            ...
            _viewModel.TipoVivienda = UoW.Catalogos.ObtenerListado(new Catalogos { NombreCatalogo = "SIM_Cat_SN_TipoVivienda", ID = 0 }).SelectListado();
